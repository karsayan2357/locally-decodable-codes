...
\begin{enumerate}
    ...
    \item Query at the $lm$ many coordinates of all the $M$-evaluations of $F$ and obtain $l$ many vectors in $\bbf_q^m$, say $\bfc^1,\ldots,\bfc^m$.
    \item For each $e\in\bbf_q$, compute:
    \[
